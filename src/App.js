...
function App() {
  ...
  return (
    <>
      ...
      <BrowserRouter>
       <Routes>
          <Route path='/' element={<TextForm showAlert={showAlert} heading="Try TextUtils- Word Counter, Character Counter, Remove Extra Spaces, Delete Text  " style={{ color: mode === 'dark' ? 'white' : 'black' }} mode={mode} />}/>
