            ...
            <div className="container my-4" style={{color:  props.mode === 'dark'? 'white'  : 'black'}}>
              <h1>{props.heading} </h1>
                <div className="mb-5">
                    ...
                    <button disabled={text.length==0} className='btn btn-primary mx-2' onClick={handleUpClick}>Text convert to upercase</button>
                    <button  disabled={text.length==0} className='btn btn-primary mx-2 ' onClick={handleloClick}>Text convert to Lowercase</button>
                    <button  disabled={text.length==0} className='btn btn-primary mx-2 ' onClick={handleClrClick}>Clear the Text</button>
